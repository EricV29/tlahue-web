  ...
  const emergencyServices = [
    {
      ...
      facebook: "https://www.facebook.com/p/Seguridad-P%C3%BAblica-y-Tr%C3%A1nsito-Municipal-de-Tlahuelilpan-Hgo-100068893222611/",
      phone: "763 786 0650",
      altPhone: "911",
    ...
    <div className="fixed bottom-6 left-6 z-50">
      <div className="relative">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="font-body text-sm font-medium">{service.phone}</span>
                </a>
                ...
                {service.altPhone && (
                  ...
                  >
                    <IconPhone className="w-4 h-4" />
                    <span className="font-body text-sm font-medium">{service.altPhone}</span>
                  </a>
                )}
                ...
                {service.facebook && (
                  ...
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M17 2H14C12.6739 2 11.4021 2.52678 10.4645 3.46447C9.52678 4.40215 9 5.67392 9 7V10H6V14H9V22H13V14H16L17 10H13V7C13 6.73478 13.1054 6.48043 13.2929 6.29289C13.4804 6.10536 13.7348 6 14 6H17V2Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                    </svg>
        ...
        <button
          ...
          className="flex items-center justify-center w-14 h-14 rounded-full bg-[#9F2241] text-white shadow-lg hover:bg-[#7d1a33] transition-all duration-300"
          aria-label="Emergencias"
        >
          <IconSiren className={`w-6 h-6 transition-transform duration-300 ${isOpen ? "rotate-45" : ""}`} />
        </button>
      </div>
    </div>
  );
