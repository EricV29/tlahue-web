  ...
  1: [
    {
      ...
      endDate: "14 feb",
      description:
        "El carnival más colorful del Valle del Mezquital con desfiles, música y baile tradicional.",
      image:
  ...
  2: [
    {
      ...
      endDate: "17 abr",
      description:
        "Representaciones religiosas y procesiones tradicionales por las calles del municipio.",
      image:
    ...
    },
    {
      ...
      endDate: "25 mar",
      description:
        "Celebración del equinoccio de primavera con actividades al aire libre y música tradicional.",
      image:
  ...
  3: [
    {
      ...
      endDate: "10 may",
      description:
        "La feria más importante del año con exposiciones ganaderas, juegos mecánicos y puestos tradicionales.",
      image:
  ...
  5: [
    {
      ...
      endDate: "29 jun",
      description:
        "Honores al santo patrono con misas, procesiones y festividades populares.",
      image:
        "https://images.unsplash.com/photo-1548625361-e88c60eb355c?w=600&h=400&fit=crop",
      location: "Parroquia de San Juan Bautista",
    },
  ],
  6: [],
  7: [
    {
      ...
      endDate: "20 ago",
      description:
        "Celebración de la flora local con exposiciones, gastronomía y actividades culturales.",
      image:
  ...
  8: [
    {
      ...
      endDate: "16 sep",
      description:
        "Celebración patriótica con Verbena Popular, fuegos artificiales y presentación del escudo local.",
      image:
        "https://images.unsplash.com/photo-1569929470868-52f8a3615013?w=600&h=400&fit=crop",
      location: "Zócalo Municipal",
    },
    {
      id: 10,
      ...
      endDate: "25 sep",
      description:
        "Exposición de artesanías locales: Talavera, bordados y productos de obsidiana.",
      image:
        "https://images.unsplash.com/photo-1459909633680-206dc5c67abb?w=600&h=400&fit=crop",
  ...
  9: [
    {
      ...
      endDate: "5 oct",
      description:
        "Celebración otoñal con plats typique de la región y competencias culinarias.",
      image:
  ...
  10: [
    {
      ...
      endDate: "2 nov",
      description:
        "Tradición centenaria con altares, recorrido de catrinas y música de盼乐队.",
      image:
        "https://images.unsplash.com/photo-1509622905150-fa66d3906e09?w=600&h=400&fit=crop",
      location: "Zócalo Municipal",
    },
    {
      ...
      endDate: "20 nov",
      description:
        "Exposición de ganado ovino y caprino con subastas y competencias.",
      image:
        "https://images.unsplash.com/photo-1500043357865-c6b88277108f?w=600&h=400&fit=crop",
  ...
  11: [
    {
      ...
      endDate: "24 dic",
      description:
        "Posadas tradicionales en el zócalo con villancicos, piñatas y ponche.",
      image:
        "https://images.unsplash.com/photo-1512909006721-3d6018887383?w=600&h=400&fit=crop",
      location: "Zócalo Municipal",
    },
    {
      id: 15,
      ...
      endDate: "23 dic",
      description:
        "Competencia de arte en rábanos, figuras deiflora y pasteles tradicionales.",
      image:
        "https://images.unsplash.com/photo-1482517967863-00e15c9b44be?w=600&h=400&fit=crop",
    ...
    <section id="novedades" className="py-16 px-6 bg-[#FEFFFC]">
      <div className="max-w-[1280px] mx-auto">
        <div className="text-center mb-8 flex flex-col items-center gap-1.5">
          <span className="text-[11px] font-mono tracking-[0.05em] uppercase text-[#D5B35F] bg-[#D5B35F]/10 px-2.5 py-0.5 rounded border border-[#D5B35F]/20">
            Actualidad Local
          </span>
          <h2 className="font-display font-light text-[40px] text-[#111827] tracking-[-0.0200em] leading-[1.1]">
            Novedades
          </h2>
        </div>
